...
case "v_car":
{
	...
	_unit addWeaponCargoGlobal [([_RAT,true] call f_fnc_arrayCheck), 1];	
	...
	_unit addItemCargoGlobal ["ACE_tourniquet", 15];
	_unit addItemCargoGlobal ["ACE_bloodIV_250", 15];
...
case "v_tr":
{
	...
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal [([_binos1,true] call f_fnc_arrayCheck),1];
	_unit addWeaponCargoGlobal [([_carbine,true] call f_fnc_arrayCheck), 4];
	_unit addWeaponCargoGlobal [([_RAT,true] call f_fnc_arrayCheck), 2];
...
{
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal ["Medkit",1];
	_unit addMagazineCargoGlobal [_grenade, 8];
	_unit addmagazineCargoGlobal [_grenadealt,6];
	_unit addMagazineCargoGlobal [_smokegrenade, 8];
	_unit addMagazineCargoGlobal [_smokegrenadealt, 2];
...
case "crate_small":
{
	...
	_unit addItemCargoGlobal ["ACE_bloodIV_250", 1];
