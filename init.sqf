...
f_script_setGroupIDs = [] execVM "f\setGroupID\f_setGroupIDs.sqf"; // Group IDs
...
if hasInterface then { 
	...
	f_sqf_ftmk = execVM "f\setTeamColours\f_setTeamColours.sqf"; // Buddy Team Colors
	...
	f_sqf_ftmrk = execVM "f\FTMemberMarkers\f_initFTMarkers.sqf"; // F3 - Fireteam Member markers
};
// ==================================================================================== EOF