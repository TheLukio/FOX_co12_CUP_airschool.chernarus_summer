...
player createDiaryRecord ["Diary", ["Body Bag", 
	format["<br/><font size='18' color='#FFBA26'>Body Recovery</font><br/>Body Bag respawn is active - Any bagged player will respawn in <font color='#00FFFF'>%1 Seconds</font color>.",
