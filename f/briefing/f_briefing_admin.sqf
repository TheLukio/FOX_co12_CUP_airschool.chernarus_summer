...
_missionZeus = format["
<font size='18' color='#FFBA26'>ZEUS SUPPORT</font><br/>
<execute expression=""
...
_missionZeus = _missionZeus + "<font size='18' color='#FFBA26'>Objects</font><br/>";
...
// SAFE START SECTION
_missionSafe = "<br/><font size='18' color='#FFBA26'>SAFE START CONTROL</font><br/><br/>
...
// DEBUG SECTION
_missionDebug = "<font size='18' color='#FFBA26'>DEBUG OPTIONS</font><br/><br/>
...
if ("acre_main" in activatedAddons) then {
	private _missionAcre = "<font size='16' color='#FFBA26'>ACRE</font><br/>Clicking any of the below will automatically add the item to your uniform inventory.<br/><br/>";
...
// TRIGGER SECTION
_missionTrigger = "<font size='18' color='#FFBA26'>TRIGGER OPTIONS</font><br/><br/>This details all triggers in the mission and will allow them to be force-completed, deleted or resulting code executed on the server. Special syntax such as 'thisTrigger' when used in activation code, WILL NOT be functional if executing the code manually - The trigger should be force Activated instead.<br/>";
...
{	// Trigger Check
	...
	<font color='#FFBA26'><execute expression=""if !(triggerActivated %1) then { { if (!isNil '%1') then { %1 setTriggerStatements ['true',(triggerStatements %1)#1, (triggerStatements %1)#2] };} remoteExec ['BIS_fnc_spawn',2]; hintSilent 'Trigger %1 already Activated'; } else { hintSilent 'Trigger %1 is already enabled' };"">Activate</execute></font> 
...
// FRAMEWORK SECTION
_missionFramework = "<font size='18' color='#FFBA26'>FRAMEWORK CONTROL</font><br/><br/>
Lists the core features of the framework and allows for forced-start, re-runs or termination core components.<br/>
<br/>
Enhanced Logging: <font color='#FFBA26'><execute expression=""f_param_debugMode = 1; publicVariable 'f_param_debugMode';hintSilent 'Logging: On';"">On</execute></font> | 
...

{
	...
	%1: <font color='#FFBA26'><execute expression=""{%2 = execVM '%3';} remoteExec ['BIS_fnc_spawn', 0];"">Run</execute></font> | <font color='#CF142B'><execute expression=""[%2] remoteExec ['terminate',0]"">Terminate</execute></font><br/>",_title, _variable, _location];
} forEach [
...
_missionWeather = "<font size='18' color='#FFBA26'>TIME / WEATHER / VIEW</font><br/>
<br/><font color='#FFBA26'>TIME</font>
...
<br/>
<br/><font color='#FFBA26'>DELAY</font>
...
<br/>
<br/><font color='#FFBA26'>CLOUDS/RAIN</font>
...
<br/>
<br/>
<font color='#FFBA26'>GLOBAL VIEW DISTANCE</font>
...
private _missionEndings = "<font size='18' color='#FFBA26'>ENDINGS</font><br/><br/>These endings are available. To trigger an ending click on its link - It will take a few seconds to synchronise across all clients.<br/><br/>";
...
fnc_AdminTasking = {
	_taskText = "<font size='18' color='#FFBA26'>TASKS</font><br/><br/>These tasks are present in the mission. To complete a task click on its link.<br/>";
	_taskList = [];
	...
	
	{
		...
		_taskText = _taskText + format [
			"%6%5<img image='\A3\ui_f\data\igui\cfg\simpleTasks\types\%2_ca.paa' height='16'/> <font color='#FFBA26'>%3</font> [<font color='#0080ff'><execute expression=""['%1','ASSIGNED'] remoteExec ['BIS_fnc_taskSetState',0];"">Assign</execute></font>] [<font color='#FFBA26'><execute expression=""['%1','SUCCEEDED'] remoteExec ['BIS_fnc_taskSetState',0];"">Complete</execute></font>] [<font color='#CF142B'><execute expression=""['%1','FAILED'] remoteExec ['BIS_fnc_taskSetState',0];"">Fail</execute></font>] [<font color='#CCCCCC'><execute expression=""['%1','CANCELED'] remoteExec ['BIS_fnc_taskSetState',0];"">Cancel</execute></font>]<br/>%5%4<br/>",
			_x,
...
if (f_var_CustomNotes != "") then {
	_missionNotes = "<br/><font size='18' color='#FFBA26'>MISSION-MAKER NOTES</font><br/>";
...
_adminIntro ="<br/><font size='18' color='#FFBA26'>ADMIN SECTION</font><br/><br/>This briefing section can only be seen by server administrators.<br/><br/>";
