...
private _orbatText = "<br/><font size='18' color='#FFBA26'>ORDER OF BATTLE</font><br/>The ORBAT below is <b>ONLY</b> accurate at mission start.<br/><br/>";
private _groups = [];
...
_orbatText = _orbatText + format["<br /><font size='18' color='#FFBA26'>%1 GROUP</font><br />",toUpper(groupId group player)];
...
if (count _vehArray > 0) then {
	_orbatText = _orbatText + "<br/><br/><font size='18' color='#FFBA26'>VEHICLE CREWS + PASSENGERS</font><br/>";
...
if (count _vehArray > 0) then {
	_orbatText = _orbatText + "<br/><br/><font size='18' color='#FFBA26'>OTHER VEHICLES</font><br/>All empty vehicles available near units:<br/><br/>";
