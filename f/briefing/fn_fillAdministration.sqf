...
if (_diaryText == "") then { _diaryText = _diaryText + "<br/><font size='18' color='#FFBA26'>ADMINISTRATION</font><br/>The following text has been auto-generated from the mission modules and parameters.<br/>" };
...
// ENVIRONMENT
_diaryText = _diaryText + "<br/><font size='18' color='#FFBA26'>ENVIRONMENT</font>";
...
if (missionNamespace getVariable["f_param_groupMarkers",0] > 0) then {
	switch (f_param_groupMarkers) do {
		case 4;
		case 5: { 
			_diaryText = _diaryText + "<br/><br/><font size='18' color='#FFBA26'>MARKERS</font>";
...
if (missionNamespace getVariable["f_param_radioMode", -1] >= 0) then {
	_diaryText = _diaryText + "<br/><br/><font size='18' color='#FFBA26'>RADIOS</font>";
...
// RESPAWN / JIP
_diaryText = _diaryText + "<br/><br/><font size='18' color='#FFBA26'>JIP / RESPAWN</font>";
...
// MEDICAL
_diaryText = _diaryText + "<br/><br/><font size='18' color='#FFBA26'>MEDICAL</font>";
...
if (missionNamespace getVariable ["f_var_medical_level", 0] > 0 && (getMissionConfigValue ["ReviveMode",0] == 0)) then {
	switch (f_var_medical_level) do {
		case 1: { // FAROOQ
			...
			_diaryText = _diaryText + format["<br/><font color='#FFBA26'>Settings</font>
		...
		case 2: { // ACE
			...
			if ((missionNamespace getVariable ["ace_medical_treatment_locationPAK", 0]) != 4) then {
				_diaryText = _diaryText + format["<br/><font color='#FFBA26'>Personal First-Aid Kits (PAK)</font>
				...
				_diaryText = _diaryText + "<br/><font color='#FFBA26'>Personal First-Aid Kits (PAK)</font><br/>PAKs are not permitted.";
			};

			// SURGICAL KIT OR NOT
			if (missionNamespace getVariable ["ace_medical_treatment_woundReopening", false]) then {
				_diaryText = _diaryText + format["<br/><font color='#FFBA26'>Surgical Kits</font>
				...
				_diaryText = _diaryText + "<br/><font color='#FFBA26'>Surgical Kits</font><br/>Wounds do not re-open -Surgical Kits are not required.";
			};
		};
	};
} else {
