...
_text = "<br/><font size='18' color='#FFBA26'>LOADOUT SELECTION</font><br/><br/>
...
<br/>
Once you have moved away from your spawn position you can not change equipment. 
<br/>
Remove unnecessary equipment to free up inventory space:<br/>
<br/>
<font size='16'>[</font><font size='16'><execute expression=""[player,TRUE] call f_fnc_tidyGear;"">Night Gear</execute></font><font size='16'>]</font><br/>Removes any items unnecessary for a  night time operations.<br/>
<br/>
<font size='16'>[</font><font size='16'><execute expression=""[player,FALSE] call f_fnc_tidyGear;"">Daytime Gear</execute></font><font size='16'>]</font><br/>Removes any items unnecessary for a day time operations.<br/>
<br/>";
...
_fnc_itemText = {
	...
	format["<font size='16'>%1</font><font size='16' color='#FFBA26'>%2</font><br/><font color='#777777'>%3</font>",
...
// Primary
{
	...
	[1, "<br/><font size='18' color='#FFBA26'>PRIMARY WEAPON</font><br/><font size='16'>[</font><font size='16'><execute expression=""[getArray(configFile >> 'CfgWeapons' >> (primaryWeapon player) >> 'magazines')] call f_fnc_matchingItem"">Current Primary Magazines</execute></font><font size='16'>]</font><br/><br/>",
	...
	[301, "<br/><font size='18' color='#FFBA26'>ATTACHMENT - POINTERS</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
	...
	[201, "<br/><font size='18' color='#FFBA26'>ATTACHMENT - OPTICS</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
			if !('%1' in primaryWeaponItems player) then {
				player addPrimaryWeaponItem '%1';
				systemChat '[GEAR] Equipped item %2.';
	...
	[101, "<br/><font size='18' color='#FFBA26'>ATTACHMENT - MUZZLE</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
			if !('%1' in primaryWeaponItems player) then {
				player addPrimaryWeaponItem '%1';
				systemChat '[GEAR] Equipped item %2.';
	...
	[302, "<br/><font size='18' color='#FFBA26'>ATTACHMENT - UNDERBARREL</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
			if !('%1' in primaryWeaponItems player) then {
				player addPrimaryWeaponItem '%1';
				systemChat '[GEAR] Equipped item %2.';
	...
	[4, "<br/><font size='18' color='#FFBA26'>SECONDARY WEAPON</font><br/><font size='16'>[</font><font size='16'><execute expression=""[getArray(configFile >> 'CfgWeapons' >> (secondaryWeapon player) >> 'magazines')] call f_fnc_matchingItem"">Current Secondary Magazines</execute></font><font size='16'>]</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
	...
	[2, "<br/><font size='18' color='#FFBA26'>HANDGUN WEAPON</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
	...
	[4096, "<br/><font size='18' color='#FFBA26'>OTHER ITEMS</font><br/><br/>",
		"<font size='16'>[</font><font size='16'><execute expression=""if ([] call f_fnc_inStartLocation) then {
...
if (_textGR != "") then {
	...
	_text = _text + format["<br/><font size='18' color='#FFBA26'>GRENADES (%1 Maximum)</font><br/>Swap out your grenades for a different type, or remove them entirely to reduce your weight.<br/><br/>",f_var_signalGMax] + 
...
if (_textTS != "") then {
	_text = _text + format["<br/><font size='18' color='#FFBA26'>SIGNALLING - HAND-HELD (%1 Maximum)</font><br/>Change your signalling items for more useful ones, or remove them entirely to reduce your weight.<br/><br/>",f_var_signalHMax] + 
...
if (_textGL != "") then {
	_text = _text + format["<br/><br/><font size='18' color='#FFBA26'>SIGNALLING - GRENADE LAUNCHED (%1 Maximum)</font><br/>Swap out your launcher signalling items for more useful ones, or remove them entirely to reduce your weight.<br/><br/>",f_var_signalLMax] + 
...
// ========================
// Clothing
_text = _text + "<br/><br/><font size='18' color='#FFBA26'>CLOTHING</font><br/>";

private _textTmp = "";
private _textTmp2 = "";

// Glasses
_text = _text + "<br/><font size='16' color='#FFBA26'>Goggles</font><br/>";

private _gogglesList = missionNamespace getVariable [format["%1_goggles",_gearVar],[]];

if (count _gogglesList > 1) then {	
	{
		_textTmp = _textTmp + format["%3 [<font><execute expression=""if (goggles player != '%1') then {systemChat '[GEAR] Equipped %2'; player addGoggles '%1';} else {systemChat '[GEAR] Already Equipped';};"">Add</execute></font>] %2%4<br/>",
		_x,
...
// Headgear
_text = _text + "<br/><font size='16' color='#FFBA26'>Headgear</font><br/>";
...
if (count _headgearList > 1) then {
	{
		_textTmp2 = _textTmp2 + format["%3 [<font><execute expression=""if (headgear player != '%1') then {systemChat '[GEAR] Equipped %2'; player addHeadgear '%1';} else {systemChat '[GEAR] Already Equipped';};"">Add</execute></font>] %2%4<br/>",
		_x,
		[getText (configFile >> "CfgWeapons" >> _x >> "displayName"),_stringFilter] call BIS_fnc_filterString,
		[_x,15] call _fnc_itemPicture,
		if (headgear player == _x) then {" <font color='#00FFFF'>* Default *</font>"} else { "" }];
...
// Uniform
_text = _text + "<br/><font size='16' color='#FFBA26'>Uniform (%FULL)</font><br/>";
...
// Vest
_text = _text + "<br/><font size='16' color='#FFBA26'>Vest (%FULL)</font><br/>";
...
// Backpack
_text = _text + "<br/><font size='16' color='#FFBA26'>Backpack (%FULL)</font><br/>";
...
_text = _text + "<br/><br/><font size='18' color='#FFBA26'>MISC ITEMS (#):</font><br/>";
