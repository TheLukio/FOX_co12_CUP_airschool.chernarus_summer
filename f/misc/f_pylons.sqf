...

{
	...
	_pylonOwners = _pylonOwners + format[" | <execute expression=""systemChat '%3 (%5) owner: Default'; f_var_pylon_%1_owner set [%4,0];"">Clear</execute> - <font color='#FFBA26'>%3</font><br/>", _vType, "", configName _x, _forEachIndex, _pylonStr];
...
_pylonRecord = _pylonRecord + "<font size='12' color='#FFBA26'>Magazine Type</font> | <font size='12'>Pylon ID</font><br/><font size='10'>Magazine Description<br/></font><br/>";
...
// For each mag, add 
{
	...
	_pylonRecord = _pylonRecord + format["<font size='12' color='#FFBA26'>%1 </font>", _name];
