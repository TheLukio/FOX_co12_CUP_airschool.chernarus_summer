...
switch (playerSide) do { //longrange, shortrange, rifradio
    case (west): {
      _radio1 = TFAR_defaultRadio_Backpack_west;         // TFAR_MR3000_multicam
      _radio2 = TFAR_defaultRadio_Personal_West;	// Configurable  TFAR_anprc152
      _radio3 = TFAR_defaultRadio_Rifleman_West;};	// Basic "TFAR_rf7800str";
    case (east): {
      _radio1 = TFAR_defaultRadio_Backpack_east;    // TFAR_mr3000
      _radio2 = TFAR_defaultRadio_Personal_east;	// Configurable TFAR_defaultRadio_Personal_east
      _radio3 = TFAR_defaultRadio_Rifleman_East;};	// Basic TFAR_pnr1000a
    default {
      _radio1 = TFAR_defaultRadio_Backpack_Independent; // TFAR_anprc155 
      _radio2 = TFAR_defaultRadio_Personal_Independent;	// Configurable TFAR_anprc148jem
      _radio3 = TFAR_defaultRadio_Rifleman_Independent;};	// Basic TFAR_anprc154
};
