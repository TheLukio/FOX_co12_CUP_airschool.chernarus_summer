...
switch (playerSide) do {
	case west: {		
		_srRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Personal_West >> "displayName");
		_rfRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Rifleman_West >> "displayName");
		_lrRadio = getText (configFile >> "CfgVehicles" >> TFAR_DefaultRadio_Backpack_West >> "displayName");
		_srFreq = tf_freq_west select 2;
		_lrFreq = tf_freq_west_lr select 2;
	};
	case east: {
		_srRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Personal_East >> "displayName");
		_rfRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Rifleman_East >> "displayName");
		_lrRadio = getText (configFile >> "CfgVehicles" >> TFAR_DefaultRadio_Backpack_East >> "displayName");
		_srFreq = tf_freq_east select 2;
		_lrFreq = tf_freq_east_lr select 2;
	};
	case resistance: {
		_srRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Personal_Independent >> "displayName");
		_rfRadio = getText (configFile >> "CfgWeapons" >> TFAR_DefaultRadio_Rifleman_Independent >> "displayName");
		_lrRadio = getText (configFile >> "CfgVehicles" >> TFAR_DefaultRadio_Backpack_Independent >> "displayName");
